...
export default function Home() {
    return (
      <div>
        ...
        <Image src="/concertphoto.jpg"width={1290}height={750}alt="Picture of Olivia Rodrigo on a concert"/>
        <h2 className="text-color-purple">Most popular Songs</h2>
        </div>
          <div className="row">
            <Album image={cover1} titel="Deja Vu" text="Deja Vu is a dreamy, slightly experimental indie-pop track built around shimmering synths, layered production, and off-kilter rhythms. The song shifts between calm, almost spoken verses and a striking, contrast-heavy chorus. Rodrigo’s vocals blend irony and vulnerability as she reflects on repeated patterns in a past relationship, giving the song a cinematic and subtly surreal atmosphere."/>
            <Album image={cover2} titel="Drivers Licsense" text="Drivers License is a soft, emotional pop ballad built around gentle piano and atmospheric production. The song slowly grows in intensity, highlighting Olivia Rodrigo’s expressive vocals and cinematic style. It became her breakout hit and introduced her signature sound."/>
            <Album image={cover3} titel="Vampire" text="Vampire is a dramatic pop song that mixes delicate piano notes with powerful, rock-inspired bursts. The track creates tension through its dynamic shifts and showcases a darker, more mature sound from Olivia Rodrigo."/>
          </div>
        ...
        <div className="row history">
          ...
          <div className="col-md-8">
            <div className="mb-3 h-100">
              <Image src="/highschoolmusical1.jpg" 
